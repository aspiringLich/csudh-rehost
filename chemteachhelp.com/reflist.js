...
comment=new Array()
emailinstructor=""
booktitle="<u>General Chemistry, Seventh Edition</u><br> Petrucci and Harwood;MacMillan Publishing<br>"
...
//emailinstructor="<br><a href='mailto:YOUR EMAIL ADDRESS'>Feedback to YOUR NAME</a><br><br>"
emailgeorge="<br><a href='mailto:gwiger@chemistry.csudh.edu'>Feedback to George Wiger</a><br><br>"
returnlink="<br><a href='lechelpintrocsn7.html'>Lecture Help Main Page</a><br>"
function setrefs(){
	thereference=comment[refnumber]+"<br>"+booktitle+theref[refnumber]+returnlink+emailinstructor+emailgeorge
	if(thisbrowser=="IE"){
...
//Significant Figures
theref[1]="Chapter 1,p.19-23,Fig 1-10(p.20)"
comment[1]=""
//Exponents
...
theref[7]="Chapter 1(p.15-18)"
comment[7]=""
//Percentage
theref[8]="For examples of percentage in chemistry see:<br>Chapter 1-Example1-4(p.18)<br>Chapter 3(p.73-74)<br>Chapter 4(p.105-106)<br>Chapter 14(p.468-472)"
comment[8]=""
//Wavelength, frequency and energy
theref[9]="Chapter 9(p.278-280)"
comment[9]=""
//Mass, density and volume-word problems
theref[10]="Chapter 1(p.15-18)"
comment[10]=""
//Exercises in comparison
theref[11]="For the basic operations needed to address these problems see:<br>Chapter 1(p.15-18)<br>Chapter 2(p.51-55)<br>The data available on your periodic table"
comment[11]=""
//Further Exercises in comparison
theref[12]="For the basic operations needed to address these problems see:<br>Chapter 1(p. 15-18)<br>Chapter 2(p.51-55)<br>The data available on your periodic table"
comment[12]=""
//Which is it?
theref[13]=theref[12]
comment[13]=""
//Mass, mole and volume-comparing two elements
theref[14]="Chapter 1(p.15-18)<br>Additional information from your periodic table"
comment[14]=""
//Make a guess #1
...
//Converting V
theref[30]="Chapter 1(p.10-15)"
comment[30]=""
//Converting M
theref[31]="Chapter 1(p.10-15)"
comment[31]=""
//Converting distance
theref[32]="Chapter 1(p.10-15)"
comment[32]=""
//Converting density
theref[33]="Chapter 1(p.10-15)"
comment[33]=""
...
theref[39]="Chapter 2 (p.40-46)"
comment[39]=""
//elements, moles and mass
theref[40]="Chapter 2(p.51-55)<br>Information available on your periodic table"
comment[40]=""
//The Periodic table
theref[41]="this is the reference"
comment[41]=""
//The quantum numbers
theref[42]="Chapter 9(p.281-293)"
comment[42]=""
//electronic structures
theref[43]="Chapter 9(p.295-303)<br>Information from periodic table"
comment[43]=""
//Atomic Spectrum of hydrogen
theref[44]="Chapter 9, sec. 9.1 to9.4,p.272-284"
comment[44]=""
//The de Broglie Wave Equation
theref[45]="Chapter 9(p. 284-285)"
comment[45]=""
//Nuclear Decay
...
//Gas Laws
//Boyle's law
theref[53]="Chapter 6:Section 6.2(p 168)"
comment[53]=""
//Charles' Law
theref[54]="Chapter 6:Section 6.2(p 170)"
comment[54]=""
//Avogadro's Law
...
comment[59]=""
//Raoult's Law
theref[60]="Chapter 14;Section 14-6(p. 481-485)"
comment[60]=""
//Clausius-Clapeyron Equation
theref[61]="Chapter 13;p428-430"
comment[61]=""
...
theref[71]="Chapter 4;Section 4-3(p.107-111)"
comment[71]=""
//Molarity, mass and volume
theref[72]="Chapter 4;Section 4-3(p.107-111)"
comment[72]=""
//Osmotic Pressure
...
theref[87]="Chapter 7,sec. 7-3,p. 207"
comment[87]=""
//heat transfer-water
...
//Thermochemistry
//Hess' Law
theref[100]="Chapter 7; section 7-7(p218-221)"
comment[100]=""
...
//Second Law
theref[110]="Chapter 20;Sections 20-4 and 20-6(p.699-703 & 704-710)"
comment[110]=""
theref[111]="this is the reference"
theref[112]="this is the reference"
//Acids and Bases
//pH,pOH, etc
theref[113]="Chapter 17,sec. 17-3,p.586"
comment[113]=""
//Solutions of acids and bases
theref[114]="Chapter 17,sec. 17-5,p.590 "
comment[114]=""
//Solutions of acids and bases
...
theref[121]="The text does not contain a discussion of this specific computation. See section 17-5(p. 590-598) and Section 5-3(p.140-144)"
comment[121]=""
//Acid-base titrations
...
theref[136]="Chapter 3;Section 3-5(p.80-89)"
comment[136]=""
...
//Chemical formulas
//Mass, moles and gfw
theref[144]="Chapter 3:Section 3-2(p68-71)"
comment[144]=""
//Chemical formulas and mass relationships
theref[145]="Chapter 3:Section 3-2,3-3(p68-78)"
comment[145]=""
//Calculations based on chemical formulas
theref[146]="Chapter 3:Section 3-2,3-3(p68-78)"
comment[146]=""
...
comment[148]=""
//Calculating GFWs
theref[149]="Chapter 3:Section 3-2(p.68)"
comment[149]=""
//Empirical Formulas
...
theref[158]="Chapter 15:Section 15-3(P.510-514)"
comment[158]=""
//Using the rate law
theref[159]="Chapter 15:sec 15.1 to 15.3(p 506-514)"
comment[159]=""
//First order processes
theref[160]="Chapter 15:sec 15.1(p506);sec15.5(p 515)"
comment[160]=""
//The Arrhenius Equation
theref[161]="Chapter 15:sec. 15-9(p 525)"
comment[161]=""
...
theref[172]="Chapter 4:sec. 4-1(p. 98-101)"
comment[172]=""
//Mass relationships in chemical reactions
theref[173]="Chapter 4:sec. 4-2(p. 101-107)"
comment[173]=""
//Limiting reagents 
theref[174]="Chapter 4:sec. 4-4(p. 112-114)"
comment[174]=""
//Calculations based on percent yields
theref[175]="Chapter 4:sec. 4-5(p. 115-117)"
comment[175]=""
//Combining limiting reagent and % yield
theref[176]="this is the reference"
comment[176]=""
//Mole relationships in chemical reactions
theref[177]="Chapter 4:sec. 4-2(p. 101-107)"
comment[177]=""
//left open
...
comment[185]=""
//Faraday's Laws
theref[186]="Chapter 21:Section 21-7(p.749)"
comment[186]=""
//The Nernst Equation
theref[187]="Chapter 21;Section 21-4(p.738-743)"
comment[187]=""
//E and K
...
//Calculating K
theref[195]="Chapter 16:sec 16-2(p. 547)"
comment[195]=""
//Calculating an Equil conc.
theref[196]="Chapter 16:ex 16, p.549"
comment[196]=""
//Q vs K
theref[197]="Chapter 16:sec 16-5(p. 556)"
comment[197]=""
//The LeChatelier Effect
theref[198]="Chapter 16:sec. 16-6(p.559)"
comment[198]=""
//Combining Equilibria
theref[199]="Chapter 16:sec 16-3(p. 550)"
comment[199]=""
//left open 
//Adv Equilibria #1
theref[200]="Chapter 16:ex. 16-10 p 566"
comment[200]=""
//Kc and Kp
theref[201]="Chapter 15:p 552-522"
comment[201]=""
